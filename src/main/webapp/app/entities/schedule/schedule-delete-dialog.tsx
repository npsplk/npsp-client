...
export class ScheduleDeleteDialog extends React.Component<IScheduleDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.scheduleEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="npspClientApp.schedule.delete.question">Are you sure you want to delete this Schedule?</ModalBody>
        <ModalFooter>
