    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/config/vehicle-facility" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>&nbsp;
          <Button tag={Link} to={`/config/vehicle-facility/${vehicleFacilityEntity.id}/edit`} replace color="primary">
